...
{
    public class ADT_A40Controller : ApiController
    {
        //
        // GET: /ADT_A04_/
        public Patient Get()
        ...
        public async Task<HttpResponseMessage> Get(string aptRecId, string caseId, string patientId, string mergepatientId, string msgControlId)
        {
            ADT_A40_Message result;
            try
            {
                ...
                var client = ServiceFactory.GetService(typeof(ADT_A40_Message));
                result = await client.GetADT_A40_Message(aptRecId, caseId, patientId, mergepatientId);
        ...
        async public void SendAck(AckParam ack)
        {
            ...
            {
                RIS risObj = new RIS();
                risObj.ReceiveADTA40Acknowledgment(ack.Acknowledgment);
            }
        }
    }
}